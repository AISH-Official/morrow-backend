...
public class DashboardService {
 ...
 public record DashboardData(String wellnessLoad,int score,boolean hasHealthData,String scoreConfidence,List<String> scoreReasons,OffsetDateTime lastUpdatedAt,Metrics metrics,HealthSignalSnapshotService.HealthDetails healthDetails,List<Timeline> timelines,Recommendation recommendation){}
