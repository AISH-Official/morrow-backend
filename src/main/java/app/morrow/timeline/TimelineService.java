...
public class TimelineService {
 ...
 public List<Timeline> findRecentByUserId(String userId,OffsetDateTime after){var values=new java.util.ArrayList<>(repository.findByUserIdAndOccurredAtAfterOrderByOccurredAtAsc(userId,after));values.addAll(repository.findByUserIdAndOccurredAtIsNullAndCreatedAtAfterOrderByCreatedAtAsc(userId,after));return values;}
