...
public class DashboardController {
 ...
 record RecommendationResponse(String id,String title,String rationale,String action,int durationSeconds,String source,boolean personalized){static RecommendationResponse from(Recommendation r){return new RecommendationResponse(r.getId().toString(),r.getTitle(),r.getRationale(),r.getAction().name(),r.getDurationSeconds(),r.getSource().name(),r.getSource()!=Recommendation.Source.RULE);}}
