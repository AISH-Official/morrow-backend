...
public class AssistantController {
 ...
 @GetMapping("/status") StatusResponse status(){var value=service.status();return new StatusResponse(value.enabled(),value.keyConfigured(),value.model(),value.ready(),value.recentState(),value.successfulRequests(),value.failedRequests(),value.retriedRequests(),value.consecutiveFailures(),value.lastSuccessAt(),value.lastFailureAt(),value.lastFailureType(),value.lastFailureStatus());}
 ...
 record StatusResponse(boolean enabled,boolean keyConfigured,String model,boolean ready,String recentState,long successfulRequests,long failedRequests,long retriedRequests,int consecutiveFailures,java.time.Instant lastSuccessAt,java.time.Instant lastFailureAt,String lastFailureType,Integer lastFailureStatus){}
