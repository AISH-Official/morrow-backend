...
public class AssistantController {
 ...
 record StatusResponse(boolean enabled,boolean keyConfigured,String model,String shortModel,String fallbackModel,boolean ready,String recentState,long successfulRequests,long failedRequests,long retriedRequests,int consecutiveFailures,java.time.Instant lastSuccessAt,java.time.Instant lastFailureAt,String lastFailureType,Integer lastFailureStatus,String lastSuccessfulModel){}
