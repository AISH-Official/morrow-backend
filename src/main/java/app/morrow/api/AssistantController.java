...
public class AssistantController {
 ...
 @GetMapping("/status") StatusResponse status(){var value=service.status();return new StatusResponse(value.enabled(),value.keyConfigured(),value.model(),value.shortModel(),value.fallbackModel(),value.ready(),value.recentState(),value.successfulRequests(),value.failedRequests(),value.retriedRequests(),value.consecutiveFailures(),value.lastSuccessAt(),value.lastFailureAt(),value.lastFailureType(),value.lastFailureStatus(),value.lastSuccessfulModel(),value.reasoningEffort(),value.maxOutputTokens(),value.webSearchEnabled(),value.inputTokens(),value.cachedInputTokens(),value.outputTokens());}
 ...
 record StatusResponse(boolean enabled,boolean keyConfigured,String model,String shortModel,String fallbackModel,boolean ready,String recentState,long successfulRequests,long failedRequests,long retriedRequests,int consecutiveFailures,java.time.Instant lastSuccessAt,java.time.Instant lastFailureAt,String lastFailureType,Integer lastFailureStatus,String lastSuccessfulModel,String reasoningEffort,int maxOutputTokens,boolean webSearchEnabled,long inputTokens,long cachedInputTokens,long outputTokens){}
