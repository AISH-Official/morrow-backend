...
public class RecommendationService {
 ...
 public Recommendation create(CreateRecommendation input){var value=new Recommendation(input.userId(),input.title(),input.rationale(),input.status());if(input.checkInId()!=null)value.linkToCheckIn(input.checkInId());return recommendationRepository.save(value);}
 ...
 public record CreateRecommendation(String userId,String title,String rationale,Recommendation.Status status,UUID checkInId){public CreateRecommendation(String userId,String title,String rationale,Recommendation.Status status){this(userId,title,rationale,status,null);}}
